...
function(e) {
    ...
    c = {
        ...
        increment: function() {
            ...
            o["default"].request({
                ...
                v: "1.0",
                success: function(t) {
                    for (var n = 0; n < e.current.length; ++n) e.current[n].innerText = s.formatNumber(t.count)
                },
        ...
        getPages: function() {
            ...
            o["default"].request({
                ...
                success: function(t) {
                    for (var n = 0; n < t.length; ++n) for (var r = e.pages[t[n].url], a = 0; a < r.length; ++a) r[a].innerText = s.formatNumber(t[n].count)
                },
                failure: function(e, t) {
                    console.log(e, t)
                }
        ...
        getSiteView: function() {
            ...
            o["default"].request({
                ...
                v: "1.0",
                success: function(t) {
                    for (var n = 0; n < e.siteView.length; ++n) e.siteView[n].innerText = s.formatNumber(t)
                },
                failure: function(e, t) {
                    console.log(e, t)
                }
    ...
    u["default"](function() {
        ...
        e.scan(),
        e.increment(),
        s.isEmpty(t.pages) || e.getPages(),
        t.siteView.length && e.getSiteView(),
...
function(e, t, n) {
    ...
    i = {//后端云api填写
        ...
        request: function() {
            ...
            p = new AV.Query("Page");
            if (p.equalTo("domain", c), n.api.match(/^hk\.page\.get/)) !
            function() {
                s.pages = s.pages || [{
                    url: l
                }];
                for (var r = 0,
                a = s.pages.length; a > r; r++) s.pages[r].count = 0;
                var u = function(e) {
                    switch (n.api) {
                    case "hk.page.get":
                        for (var r = {},
                ...
                case "hk.site.totalView":
                    d.first().then(function(e) {
                        return i(e.get("count"))
                    });
                    break;
                default:
                    t()
            ...
            case "hk.page.increment":
                s.url = s.url || l,
                s.title = s.title || document.title,
                p.equalTo("url", s.url),
        ...
        importData: function(e, t) {
            ...
            for (var a = AV.Object.extend("Page"), o = [], i = 0, u = t.length; u > i; i++) {
                ...
                s.set("domain", e),
                s.set("url", t[i].url),
                s.set("title", t[i].title),
                s.set("count", t[i].count),
                o.push(s.save())
            }
...
function(e, t) {
    ...
    function r(e) {
        ...
        n = e.toString();
        return [].reduce.call(n,
        function(e, r, a) {
            var o = (n.length - a - 1) % t === 0 && a !== n.length - 1;
            return e + r + (o ? ",": "")
        },
        "")
    }
...
function(e, t, n) {
    ...
    function l(e, t) {
        ...
        if (t.singleton) {
            ...
            r = c.bind(null, n, o, !1),
            a = c.bind(null, n, o, !0)
        } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = s(t), r = p.bind(null, n), a = function() {
            i(n),
            n.href && URL.revokeObjectURL(n.href)
        }) : (n = u(t), r = f.bind(null, n), a = function() {
            i(n)
        });
        return r(e),
        function(t) {
...
function(e, t, n) {
    ...
    t.rethrow = function c(e, t, r, a) {
        ...
        i = u.slice(s, l).map(function(e, t) {
            var n = t + s + 1;
            return (n == r ? "  > ": "    ") + n + "| " + e
        }).join("\n");
        throw e.path = t,
